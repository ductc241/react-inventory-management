      ...
      <aside className="w-auto border rounded" aria-label="Sidebar">
        <div className="overflow-y-auto bg-white rounded  drop-shadow-xl">
          <ul className="space-y-2">
            ...
            <li className="px-3">
              <div className="flex items-center p-2 text-sm font-normal text-gray-900 rounded-lg hover:bg-gray-100">
            ...
            <li className="px-3">
              <div className="flex items-center p-2 text-sm font-normal text-gray-900 rounded-lg hover:bg-gray-100">
                <span className="flex-1 whitespace-nowrap space-x-2">
                  <input type="radio" />
                  <label htmlFor="">Hàng đang bán</label>
                </span>
              </div>
            </li>
            <li className="px-3">
              <div className="flex items-center p-2 text-sm font-normal text-gray-900 rounded-lg hover:bg-gray-100">
                <span className="flex-1 whitespace-nowrap space-x-2">
                  <input type="radio" />
                  <label htmlFor="">Hàng ngừng bán</label>
                </span>
              </div>
            </li>
            <br />
