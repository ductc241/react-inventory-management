...
const Signup = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-tl from-green-400 to-indigo-900 text-gray-900 flex justify-center">
                ...
                <div className="w-full flex-1 mt-8">
                  ...
                  <div className="mx-auto max-w-xs">
                    <input className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white" 
                            id="name" type="name" placeholder="Tên tài khoản" autoComplete="off"
                    ...
                    <p className="mt-6 text-xs text-gray-600 text-center">
                      Tôi đã có tài khoản! <Link to="/signin" className="hover:underline decoration-solid border-dotted text-black font-semibold hover:text-green-700">Đăng nhập thôi!</Link>
